...
!function(){"use strict";var e=document.querySelector(".post-content"),v=document.querySelector(".time-bar"),t=document.querySelector(".time-bar-header"),y=!0;if(e&&v){var g=0,h=e.scrollHeight,S=v.querySelector(".completed"),f=v.querySelector(".remaining"),w=v.querySelector(".time-completed"),E=v.querySelector(".time-remaining");document.addEventListener("scroll",function(){var e,t,n=window.pageYOffset||document.documentElement.scrollTop;if(v.style.bottom=g<n&&y?"0%":"-100%",n<=h){var r=n/h,i=(100*r).toFixed(2),o=100-parseFloat(i);S.style.width=i.toString()+"%",f.style.width=o.toString()+"%";var s=60*parseInt(v.getAttribute("data-minutes")),l=parseInt(r*s),a=parseInt(l/60),c=parseInt(60*(l/60-a)),d=s-l,u=parseInt(d/60),m=parseInt(60*(d/60-u));a=a<10?"0"+a:a,c=c<10?"0"+c:c,u=u<10?"0"+u:u,m=m<10?"0"+m:m,w.innerText=a+":"+c,E.innerText=u+":"+m,y=!0,(t=document.createEvent("CustomEvent")).initCustomEvent("stillReading"),document.dispatchEvent(t)}else{S.style.width="100%",f.style.width="0%";var p=parseInt(v.getAttribute("data-minutes"));p=p<10?"0"+p:p,w.innerText="00:00",E.innerText=p+":00",y=!1,(e=document.createEvent("CustomEvent")).initCustomEvent("finishedReading"),document.dispatchEvent(e)}g=n})}if(e&&t){var r=e.scrollHeight,i=t.querySelector(".completed"),o=t.querySelector(".remaining");document.addEventListener("scroll",function(){var e=window.pageYOffset||document.documentElement.scrollTop;if(e<=r){var t=(100*(e/r)).toFixed(2),n=100-parseFloat(t);i.style.width=t.toString()+"%",o.style.width=n.toString()+"%",!0}else i.style.width="100%",o.style.width="0%",!0;e})}}();
